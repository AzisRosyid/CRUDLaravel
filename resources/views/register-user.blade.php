...
<div class="bg-light t_rounded" id="t_login">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-item nav-link active" href="{{ url('/register') }}">Register User <span class="sr-only">(current)</span></a>
      </div>
      </div>
      </div>
</nav>
  ...
  <input type="hidden" id="level" name="level" style="display: none" value="user">
